...
<div class="min-h-screen relative flex flex-col">
    ...
    <div class="flex-grow flex items-center justify-center z-10 px-4">
        <div class="w-full max-w-md p-10 rounded-3xl shadow-lg bg-cover bg-center relative"
                ...
                <form method="POST" action="{{ route('login') }}" class="space-y-4">
                    ...
                    <div>
                        ...
                        <input type="email" name="email" id="email" value="{{ old('email') }}" required
                               class="w-full px-4 py-2 rounded-lg border border-gray-300 bg-transparent text-white placeholder-gray-300 focus:ring focus:ring-blue-300 focus:outline-none">
                    </div>
                    ...
                    <p class="mt-4 text-center text-gray-200 text-sm">
                        ¿No tienes cuenta?
                        <a href="{{ route('register') }}" class="text-blue-300 hover:underline">Regístrate aquí</a>
                    </p>
                </form>
            </div>
        </div>
