...
<div class="min-h-screen bg-cover bg-center p-6 rounded" 
     style="background-image: url('{{ asset('image/est.png') }}');">

    <!-- Fondo semi-transparente para que se lean los textos -->
    <div class="bg-white/80 p-6 rounded shadow">
        ...
        <a href="{{ route('estudiantes.create') }}" class="bg-blue-500 text-white px-4 py-2 rounded mb-4 inline-block">
